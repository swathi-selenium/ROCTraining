...
//		System.out.println(x);
		...
		int w = MethodsDemo.doSomething(10, 20); // Including the reference to MethodDriver to access add is optional
													// because I am in the same class
		System.out.println("w: " + w);

		MethodsDemo shopper = new MethodsDemo();
//		shopper.purchaseAmount = 100;
		shopper.calculateTax(100);

		MethodsDemo shopper2 = new MethodsDemo();
